  ...
  module Admin
    describe AddressesController, type: :controller do
      ...
      describe '#create_shipment' do
          ...
          context 'when shipment address present' do
            ...
            context 'when shipment address is same as order ship address' do
              ...
              before(:each) do
                ...
                allow(new_address).to receive(:save).and_return(true)
        ...
        it 'attempts to save address' do
          allow(controller).to receive(:apply_to_other_shipments)
          expect(address).to receive(:save).and_return(true)
          send_request
        end

        context 'when address is saved successfully' do
          before(:each) do
        ...
        context 'when address is not saved successfully' do
          before(:each) do
